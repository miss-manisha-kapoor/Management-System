...
import { UpdateReceptionist } from "../../../../../Redux/auth/action";
import docimg from "../../../../../img/profile.png";
import "./CSS/Profiles.css";

const Receptionist_Profile = () => {
  const {
    data: { user },
  ...
  const [formData, setFormData] = useState({
    ReceptionistName: user.ReceptionistName,
    age: user.age,
    gender: user.gender,
  ...
  const handleFormSubmit = () => {
    dispatch(UpdateReceptionist(formData, user._id));
...
export default Receptionist_Profile;
