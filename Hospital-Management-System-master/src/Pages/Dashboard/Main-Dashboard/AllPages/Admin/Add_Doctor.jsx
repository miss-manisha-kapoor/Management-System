...
const AddDoctor = () => {
  ...
  const submitHandler = (event, user) => {
    ...
    const base_url = 'http://127.0.0.1:3001/createDoctor';
    const body = {docName:initData.docName,
    age: initData.age,
    mobile: initData.mobile,
    email: initData.email,
    bloodGroup: initData.bloodGroup,
...
const [docID, setDocID] = useState();
  const HandleDoctorSubmit = (e) => {
    ...
    dispatch(DoctorRegister(DoctorValue)).then((res) => {
      ...
      console.log(ID, "DOCTOR REGISTER SUCCESSFULLY");
      ...
      submitHandler(e,res.data.docID);
    });
  };
